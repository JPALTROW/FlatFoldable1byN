...
print("\\node[above=2pt of {("+str(posX[0])+",0)}] {\\footnotesize $2a-j+2$};")
print("\\node[below right=-3pt of {("+str(posX[7])+",0)}] {\\footnotesize $a$};")
print("\\node[below right=-3pt of {("+str(posX[8])+",0)}] {\\footnotesize $a+1$};")
print("\\node[below right=-3pt of {("+str(posX[18])+",0)}] {\\footnotesize $2a-j+1$};")
